 ...
 * fillz(1, 1) // '01'
 */
export function fillz(val, count) {
 ...
 */
export function getFirstDateOfMonth(_a) {
 ...
 */
export function getLastDateOfMonth(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.offset, offset = _c === void 0 ? 0 : _c, fmt = _b.fmt;
    var date = new Date();
 ...
 */
export function getRangeDateOfMonth(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.offset, offset = _c === void 0 ? 0 : _c, fmt = _b.fmt;
 ...
 */
export function getRangeDateOfWeek(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.offset, offset = _c === void 0 ? 0 : _c, fmt = _b.fmt;
    var date = new Date();
 ...
 * getSuffix('xx.JPG') // jpg
 */
export function getSuffix(val, toUpperCase) {
 ...
 */
export function encodeHTML(val) {
 ...
 */
export function decodeHTML(val) {
    var temp = document.createElement('div');
    temp.innerHTML = val;
 ...
 * @returns { string } 结果
 */
export function validate(type, val) {
    if (isEmpty(val))
        return false;
    switch (type) {
        case 'mobilePhone': {
